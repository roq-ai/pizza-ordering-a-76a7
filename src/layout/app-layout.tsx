...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'customer'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Cart Items', path: '/cart-items', entity: 'cart_item', service: AccessServiceEnum.PROJECT, icon: FiBox },
    { name: 'Orders', path: '/orders', entity: 'order', service: AccessServiceEnum.PROJECT, icon: FiShoppingBag },
    { name: 'Pizzas', path: '/pizzas', entity: 'pizza', service: AccessServiceEnum.PROJECT, icon: FiFastForward },
